...
const APPLY_TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      card1Scale: { type: 'number', minimum: 0,    maximum: 8,    description: 'Card A zoom 1–8×' },
      card1X:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card A focal X 0–100%' },
      card1Y:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card A focal Y 0–100%' },
      card1Rot:   { type: 'number', minimum: -180, maximum: 180,  description: 'Card A rotation degrees' },
      card1Opa:   { type: 'number', minimum: 0,    maximum: 100,  description: 'Card A opacity 0–100%' },
      card2Scale: { type: 'number', minimum: 0,    maximum: 8,    description: 'Card B zoom 1–8×' },
      card2X:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card B focal X 0–100%' },
      card2Y:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card B focal Y 0–100%' },
      card2Rot:   { type: 'number', minimum: -180, maximum: 180,  description: 'Card B rotation degrees' },
      card2Opa:   { type: 'number', minimum: 0,    maximum: 100,  description: 'Card B opacity 0–100%' },
      card3Scale: { type: 'number', minimum: 0,    maximum: 8,    description: 'Card C zoom 1–8×' },
      card3X:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card C focal X 0–100%' },
      card3Y:     { type: 'number', minimum: -200, maximum: 200,  description: 'Card C focal Y 0–100%' },
      card3Rot:   { type: 'number', minimum: -180, maximum: 180,  description: 'Card C rotation degrees' },
      card3Opa:   { type: 'number', minimum: 0,    maximum: 100,  description: 'Card C opacity 0–100%' },
      // HERO CONTENT panel
